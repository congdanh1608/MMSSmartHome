...
public class LoadCommands {
    ...
    public static ArrayList<String> addCommandsConfig(RaspberryPi raspberryPi, Boolean isPublicWifi, String WifiSSID, String WifiPassword) {
        ...
        //Config screen of Rasp Pi not sleep + auto run RashServer.jar when Pi is boot + Config wifi for Rasp Pi
...
//        //Config mysql & Remove hostap + set datetime
//        listOfCommands.add("sudo shell/mysql.sh homemmsdb homemms 123456 && sudo rm /usr/sbin/hostapd & sudo apt-get -y purge isc-dhcp-server && echo EndCommands");
        return listOfCommands;
    }
